...
import { WorkfosterSampleApplicationTestModule } from '../../../test.module';
  ...
  describe('MainComponent', () => {
    ...
    beforeEach(async(() => {
      TestBed.configureTestingModule({
        imports: [WorkfosterSampleApplicationTestModule],
    ...
    describe('page title', () => {
      let routerState: any;
      const defaultPageTitle = 'WorkfosterSampleApplication';
